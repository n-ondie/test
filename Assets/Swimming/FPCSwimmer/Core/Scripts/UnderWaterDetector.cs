...
namespace FPCSwimmer
{
    public class UnderWaterDetector : MonoBehaviour
    {
        ...
        public static UnderWaterDetector Master {
            get {
                if (!_master)
                {
                    Debug.LogError("No UnderWaterDetector master instance was found in the scene. Please put one in the scene");
                }
                return _master;
            }
        }

        private static UnderWaterDetector _master;
        ...
        public void Awake()
        {
            ...
            {
                Debug.LogError("More than one UnderWaterDetector master instance was found in the scene. Please put only one in the scene.");
            }
        }
